I build a full stack dex. For building this first I decoded and uniswap v2 code and then build mine minimum viable dex. For this project I also learned typescript.
